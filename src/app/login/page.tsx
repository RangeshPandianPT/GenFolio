        ...
        <div className="p-8 md:p-12 md:w-1/2 flex flex-col bg-secondary/80 backdrop-blur-lg z-20 text-secondary-foreground">
          ...
          <div className="flex gap-4 mb-6">
            <button 
              ...
              className="flex-1 flex items-center justify-center gap-2 px-4 py-3 rounded-xl border border-border/50 bg-white text-black hover:bg-gray-50 transition-colors font-medium text-sm shadow-sm"
            >
            ...
            <button 
              ...
              className="flex-1 flex items-center justify-center gap-2 px-4 py-3 rounded-xl border border-border/50 bg-[#24292F] text-white hover:bg-[#24292F]/90 transition-colors font-medium text-sm shadow-sm"
            >
